...
import { generateUploadUrl } from '../repositories/S3Repository';
...
// --- auto-generated wrapper (added by scripts/wrap-modules.js) ---
class FileUploadServiceService {
  async listBookings(...args: any[]) { return (listBookings as any).apply(this, args); }
  async getBooking(...args: any[]) { return (getBooking as any).apply(this, args); }
  async createBooking(...args: any[]) { return (createBooking as any).apply(this, args); }
  async updateBooking(...args: any[]) { return (updateBooking as any).apply(this, args); }
  async deleteBooking(...args: any[]) { return (deleteBooking as any).apply(this, args); }
}

export default new FileUploadServiceService();
