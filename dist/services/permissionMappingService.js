...
const userPermRepo = __importStar(require("../repositories/userPermissionRepository"));
const rolePermRepo = __importStar(require("../repositories/rolePermissionRepository"));
