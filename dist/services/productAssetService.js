...
const imgRepo = __importStar(require("../repositories/productImageRepository"));
const priceRepo = __importStar(require("../repositories/productPriceRepository"));
const assignedRepo = __importStar(require("../repositories/productAssignedRepository"));
