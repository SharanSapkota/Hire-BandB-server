...
const prodRepo = __importStar(require("../repositories/productRepository"));
...
async function createProduct(payload, ownerId) {
    const { name, categoryId, productPriceId, hourlyRate, dailyRate, latitude, longitude } = payload;
    const data = { name, ownerId, categoryId, productPriceId, hourlyRate, dailyRate, latitude, longitude };
